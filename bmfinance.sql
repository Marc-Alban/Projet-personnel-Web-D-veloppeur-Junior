...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 15 jan. 2020 à 12:04
...
INSERT INTO `partenaire` (`id`, `legende`, `image`, `posted`) VALUES
(1, 'Legende', 'logoQuantalys.jpg', 1),
(2, 'Legende', 'logoWaldata.png', 1);
...
(2, 'Bertrand', 'Millet', 'bertrand.millet69@orange.fr', '$2y$10$VIU8xlq9QsvHTAfRZICbHes.E9RyFvi.qJf6.mDHAIhsSBhHBXGOu', '', 1);
COMMIT;
