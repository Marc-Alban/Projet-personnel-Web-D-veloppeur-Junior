...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 04 fév. 2020 à 16:40
...
(85, 'Dernier artticle', 'sc,slkcnsqd cdsq cds s', '<p>s fvsdvds vds vsd vds v</p>', 'default.png', '2020-02-13', 1, 1),
...
(88, 'Test article', 'Ceci est la légende', '<p>testttttttttttttttttttttttttttttt</p>\r\n<p>testttttttttttttttttttttttttttttt</p>\r\n<p>testttttttttttttttttttttttttttttt</p>', '88.png', '2020-02-20', 1, 0);
...
(1, 'Nos Valeurs', 'Je suis le titre de la page  $_SESSION', '<p>Je suis la description de la page nos valeurs bla bla bla $_SESSION</p>', 'default.png'),
...
(9, 'Conditions Générales', 'Titre condition', '&lt;p&gt;Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum ullam laudantium, alias deleniti harum id dignissimos distinctio maxime, aspernatur exercitationem tenetur magni voluptates vel. Culpa cupiditate maiores animi hic dicta?&lt;/p&gt;', 'default.png'),
...
(2, 'Bertrand', 'Millet', 'bertrand.millet69@orange.fr', '$2y$10$UKXy5VVvM8N5RNpSnivQ4.jgLqY2GG0wAQPSvO6lrhojxkrWxoaCG', '776735263a35c2a4e568067c32122383babc44f5271912e7d2624af7bf4aec65', 1);
COMMIT;
